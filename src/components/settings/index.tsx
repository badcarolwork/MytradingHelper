    ...
    <>
      ...
      <Card>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '4px 0' }}>
          <div className="wl-icon" style={{ width: 40, height: 40, fontSize: 14, background: 'rgba(59,130,246,0.15)', color: 'var(--accent2)', flexShrink: 0 }}>
        ...
        <div style={{
          ...
          <div style={{
            fontSize: 11, fontFamily: 'var(--mono)', color: 'var(--green2)',
      ...
      <Card>
        ...
        <ToggleRow
          ...
          sub={`Pause bots if loss exceeds RM ${riskConfig?.max_daily_loss?.toLocaleString() ?? '2,000'}`}
          checked
          onChange={() => {}}
        />
        {riskConfig && (
      ...
      <div style={{ textAlign: 'center', padding: '8px 0 4px' }}>
        ...
        <div style={{ fontSize: 10, color: 'var(--text3)', marginTop: 4 }}>
          Session expires 24 hours after login. Broker keys AES-256 encrypted.
        </div>
      </div>
    </>
  )
